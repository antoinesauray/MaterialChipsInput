...
public class SingleChipAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final String TAG = SingleChipAdapter.class.toString();
    ...
    public SingleChipAdapter(Context context, SingleChipInput chipsInput, RecyclerView recycler) {
        mContext = context;
    ...
    private class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        private final SingleChipView chipView;

        ItemViewHolder(View view) {
            super(view);
            chipView = (SingleChipView) view;
        }
    }
    ...
    private void handleClickOnEditText(SingleChipView chipView, final int position) {
        // delete chip

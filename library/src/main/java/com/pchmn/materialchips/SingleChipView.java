...
public class SingleChipView extends RelativeLayout {

    private static final String TAG = SingleChipView.class.toString();
    // context
    ...
    public SingleChipView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init(attrs);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        if(attrs != null) {
            TypedArray a = mContext.getTheme().obtainStyledAttributes(
                    attrs,
                    R.styleable.SingleChipView,
                    0, 0);

            try {
                // label
                mLabel = a.getString(R.styleable.SingleChipView_label);
                mLabelColor = a.getColorStateList(R.styleable.SingleChipView_labelColor);
                // avatar icon
                mHasAvatarIcon = a.getBoolean(R.styleable.SingleChipView_hasAvatarIcon, false);
                int avatarIconId = a.getResourceId(R.styleable.SingleChipView_avatarIcon, NONE);
                ...
                // delete icon
                mDeletable = a.getBoolean(R.styleable.SingleChipView_deletable, false);
                mDeleteIconColor = a.getColorStateList(R.styleable.SingleChipView_deleteIconColor);
                int deleteIconId = a.getResourceId(R.styleable.SingleChipView_deleteIcon, NONE);
                if(deleteIconId != NONE) mDeleteIcon = ContextCompat.getDrawable(mContext, deleteIconId);
                // background color
                mBackgroundColor = a.getColorStateList(R.styleable.SingleChipView_backgroundColor);
            }
            finally {
                a.recycle();
            }
    ...
    public static class Builder {
        ...
        public SingleChipView build() {
            return newInstance(this);
        }
    }

    private static SingleChipView newInstance(Builder builder) {
        SingleChipView chipView = new SingleChipView(builder.context);

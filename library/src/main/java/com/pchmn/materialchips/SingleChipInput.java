...
import com.pchmn.materialchips.adapter.SingleChipAdapter;
...
public class SingleChipInput extends ScrollViewMaxHeight {

    private static final String TAG = SingleChipInput.class.toString();
    // context
    private Context mContext;
    // xml element
    @BindView(R2.id.chips_recycler) RecyclerView mRecyclerView;
    // adapter
    private SingleChipAdapter mChipsAdapter;
    // attributes
    ...
    public SingleChipInput(Context context) {
        super(context);
        mContext = context;
        init(null);
    }

    public SingleChipInput(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init(attrs);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        if(attrs != null) {
            TypedArray a = mContext.getTheme().obtainStyledAttributes(
                    attrs,
                    R.styleable.SingleChipInput,
                    0, 0);

            try {
                // hint
                mHint = a.getString(R.styleable.SingleChipInput_hint);
                mHintColor = a.getColorStateList(R.styleable.SingleChipInput_hintColor);
                mTextColor = a.getColorStateList(R.styleable.SingleChipInput_textColor);
                mMaxRows = a.getInteger(R.styleable.SingleChipInput_maxRows, 2);
                setMaxHeight(ViewUtil.dpToPx((40 * mMaxRows) + 8));
                //setVerticalScrollBarEnabled(true);
                // chip label color
                mChipLabelColor = a.getColorStateList(R.styleable.SingleChipInput_chip_labelColor);
                // chip avatar icon
                mChipHasAvatarIcon = a.getBoolean(R.styleable.SingleChipInput_chip_hasAvatarIcon, true);
                // chip delete icon
                mChipDeletable = a.getBoolean(R.styleable.SingleChipInput_chip_deletable, false);
                mChipDeleteIconColor = a.getColorStateList(R.styleable.SingleChipInput_chip_deleteIconColor);
                int deleteIconId = a.getResourceId(R.styleable.SingleChipInput_chip_deleteIcon, NONE);
                if(deleteIconId != NONE) mChipDeleteIcon = ContextCompat.getDrawable(mContext, deleteIconId);
                // chip background color
                mChipBackgroundColor = a.getColorStateList(R.styleable.SingleChipInput_chip_backgroundColor);
                // show chip detailed
                mShowChipDetailed = a.getBoolean(R.styleable.SingleChipInput_showChipDetailed, true);
                // chip detailed text color
                mChipDetailedTextColor = a.getColorStateList(R.styleable.SingleChipInput_chip_detailed_textColor);
                mChipDetailedBackgroundColor = a.getColorStateList(R.styleable.SingleChipInput_chip_detailed_backgroundColor);
                mChipDetailedDeleteIconColor = a.getColorStateList(R.styleable.SingleChipInput_chip_detailed_deleteIconColor);
                // filterable list
                mFilterableListBackgroundColor = a.getColorStateList(R.styleable.SingleChipInput_filterable_list_backgroundColor);
                mFilterableListTextColor = a.getColorStateList(R.styleable.SingleChipInput_filterable_list_textColor);
            }
            finally {
                a.recycle();
            }
        ...
        // adapter
        mChipsAdapter = new SingleChipAdapter(mContext, this, mRecyclerView);
    ...
    public SingleChipView getChipView() {
        int padding = ViewUtil.dpToPx(4);
        SingleChipView chipView = new SingleChipView.Builder(mContext)
    ...
    public SingleChipInput setMaxRows(int mMaxRows) {
    ...
    public SingleChipInput setShowChipDetailed(boolean mShowChipDetailed) {
